...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			{ pattern: 'www/vendor-js/chart.js', included: true, watched: false },
			{ pattern: 'www/vendor-js/chartjs-plugin-zoom.min.js', included: true, watched: false },
			{ pattern: 'www/vendor-js/chartjs-adapter-date-fns.bundle.min.js', included: true, watched: false },
